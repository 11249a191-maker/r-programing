...
R Program:
simple_interest <- function(l, m, n){
si <- (l * m * n) / 100
return(si)
}
simple_interest(2000, 40, 3)
...
calculate_gpa(c(80, 85, 95, 77, 84))
...
insurance_premium(5000, 65, TRUE)
